...
def accuracy_reward(completions, answer, **kwargs):
    ...
    for content, sol in zip(contents, answer):
        ...
        if len(gold_parsed) != 0:
            ...
            # If the gold answer is not parseable, we reward 1 to skip this example
            reward = 1.0
            # print("accuracy_reward: Failed to parse gold answer: ", sol)
...
def len_reward(completions: list[Dict[str, str]], answers: list[str], **kwargs) -> float:
    ...
    correctness = []
    for content, sol in zip(contents, answers):
        ...
        if len(gold_parsed) == 0:
            ...
            # print("len_reward: Failed to parse gold answer: ", sol)
            continue
    ...
    def cosine_scaled_reward(completions, answer, **kwargs):
        ...
        for content, sol in zip(contents, answer):
            ...
            if len(gold_parsed) == 0:
                ...
                # print("cosine_scaled_reward: Failed to parse gold answer: ", sol)
                continue
